...
#include "./includes/scene_lua.hpp"
#include <iostream>
#include <cctype>
#include <cstring>
#include <cstdio>
#include "lua488.hpp"
#include "./includes/JointNode.hpp"
#include "./includes/GeometryNode.hpp"
...
int gr_material_cmd(lua_State* L)
{
  ...
  data->material->textureId = textureId;
...
int gr_node_set_material_cmd(lua_State* L)
{
  ...
  self->material.textureId = material->textureId;
